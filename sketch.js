...
//a boolean to track whether or not we're on the start screen!!!!!!!!
...
function draw() {
  ...
  //the rest of our program (whatever we want!)
  else {
    displayFortuneTeller();
  }
}
...
function displayStartScreen() {
  ...
  textSize(50);
  text("What is your fortune today?", width/2, height/2);
}

function displayFortuneTeller() {
...
function mousePressed() {
  ...
  //if we're on the start screen, turn it off
  if (startScreen == true) {
    startScreen = false;  
  }
